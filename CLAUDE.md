...
**第47話「あの公園」が最終話。** 解放は配列の先頭から順なので、
**配列のいちばん最後の話が、その子にとっての最終話になる。**
第41〜46話（前日談）だけを足したときは、最後に読むのが「はじまりの話」になって
現在が閉じなくなったため、現在にもどる話を1本足してしめた。

つぎに話を足すときは、いつもどおり**末尾に足してよい**。そのぶん「あの公園」は
最終話ではなくなるので、しめの話がほしければ、そのときまた1本書きたす。
