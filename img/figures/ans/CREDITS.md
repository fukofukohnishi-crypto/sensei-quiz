...
| `shotokutaishi.webp` | 聖徳太子 の肖像 | PD の肖像画をまとめた1枚の画像から切り出し | **PD**（パブリックドメイン） | 表示不要 |
...
| `umako.webp` | 蘇我馬子 の肖像 | PD の肖像画をまとめた1枚の画像から切り出し | **PD**（パブリックドメイン） | 表示不要 |
...
> 人物の肖像13枚は、パブリックドメインの肖像画を1枚にまとめた画像から切り出したもの。
> **1枚ずつの出どころ（所蔵・作者）までは確かめられていない。** どれも著作権の切れた
> 古い肖像画・古写真だが、**聖徳太子**（教科書は「唐本御影」）と**蘇我馬子**（同時代の
> 肖像は伝わっていない）の2枚は、教科書で使われる絵と同じかどうか要確認。
> 差しかえるときは**同じファイル名**にすれば、子供の端末の絵も入れかわる。
